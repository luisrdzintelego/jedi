...
function chk_adelante3() {
  //console.log("🚀 ~ init_tarjetas3:")
  //console.log("🚀 ~ tarjetas3:", tarjetas3)
  console.log("🚀 ~ tarj_actual3:", tarj_actual3)
	  ...
	  (function (i) {
		...
		$(".panel3" + i).keydown(function (e) {
		  ...
		  if (key == 9)  // the enter key code
		  {
			...
			//console.log("🚀 ~ key:", $('.btn-atras3').is(":disabled"))
			console.log("🚀 ~ e.shiftKey:", e.shiftKey)

			/* console.log("🚀 ~ tarj_actual3 <= 1:", tarj_actual3 <= 1)
			console.log("🚀 ~ tarj_actual3 >= tarjetas3.length :", tarj_actual3 >= tarjetas3.length )
			console.log("🚀 ~ tarj_actual3 :", tarj_actual3 )
			console.log("🚀 ~ tarjetas3.length :", tarjetas3.length ) */
