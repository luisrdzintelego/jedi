...
function chk_adelante2() {
  //console.log("🚀 ~ init_tarjetas2:")
  //console.log("🚀 ~ tarjetas2:", tarjetas2)
  console.log("🚀 ~ tarj_actual2:", tarj_actual2)
	  ...
	  (function (i) {
		...
		$(".panel2" + i).keydown(function (e) {
		  ...
		  if (key == 9)  // the enter key code
		  {
			...
			//console.log("🚀 ~ key:", $('.btn-atras2').is(":disabled"))
			console.log("🚀 ~ e.shiftKey:", e.shiftKey)

			/* console.log("🚀 ~ tarj_actual2 <= 1:", tarj_actual2 <= 1)
			console.log("🚀 ~ tarj_actual2 >= tarjetas2.length :", tarj_actual2 >= tarjetas2.length )
			console.log("🚀 ~ tarj_actual2 :", tarj_actual2 )
			console.log("🚀 ~ tarjetas2.length :", tarjetas2.length ) */
