							...
							<div className="mb-3">
								<div className="row mt-1">
									<div className="col-md-12">
										...
										<h2 className=' fs-18 lh-25 c-negro text-left'>Quienes han logrado encontrarla dicen que su gran poder de los <b>Principios Scrum</b> les ha permitido implementar diferentes rutinas en su dinámica de trabajo que les permiten ser más agiles.</h2>
									</div>
								</div>
							</div>
