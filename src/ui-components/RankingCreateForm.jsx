...
export default function RankingCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setTiempo(initialValues.tiempo);
    setGema1(initialValues.gema1);
    setGema2(initialValues.gema2);
    setGema3(initialValues.gema3);
    setBonus1(initialValues.bonus1);
    setBonus2(initialValues.bonus2);
    setBonus3(initialValues.bonus3);
    setIntentos(initialValues.intentos);
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (isNaN(value)) {
            setErrors((errors) => ({
              ...errors,
              puntos: "Value must be a valid number",
            }));
            return;
          }
          if (onChange) {
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (isNaN(value)) {
            setErrors((errors) => ({
              ...errors,
              tiempo: "Value must be a valid number",
            }));
            return;
          }
          if (onChange) {
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (isNaN(value)) {
            setErrors((errors) => ({
              ...errors,
              intentos: "Value must be a valid number",
            }));
            return;
          }
          if (onChange) {
